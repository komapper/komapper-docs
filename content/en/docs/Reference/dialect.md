...
| kotlin.ByteArray               | BLOB                     | `BlobByteArray` must be specified as [alternate type]({{< relref "data-type#alternate-types" >}}).                                                                        |
...
| kotlin.UInt                    | BIGINT                   |                                                                                                                                                                           |
| kotlin.UShort                  | INT                      |                                                                                                                                                                           |
| kotlin.time.Instant            | TIMESTAMP WITH TIME ZONE |                                                                                                                                                                           |
...
| kotlin.ByteArray               | varbinary         |                                                                                                                                                                           |
| kotlin.ByteArray               | varbinary(max)    | `BlobByteArray` must be specified as [alternate type]({{< relref "data-type#alternate-types" >}}).                                                                        |
| kotlin.Double                  | float             |                                                                                                                                                                           |
| kotlin.Float                   | real              |                                                                                                                                                                           |
| kotlin.Int                     | int               |                                                                                                                                                                           |
| kotlin.Long                    | bigint            |                                                                                                                                                                           |
...
| kotlin.UInt                    | bigint            |                                                                                                                                                                           |
| kotlin.UShort                  | int               |                                                                                                                                                                           |
| kotlin.time.Instant            | datetimeoffset    |                                                                                                                                                                           |
| kotlinx.datetime.LocalDate     | date              |                                                                                                                                                                           |
